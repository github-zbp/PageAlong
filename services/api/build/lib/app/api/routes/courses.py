...
from app.worker_client import enqueue_audio_generation, enqueue_url_import
...
def delete_course_series(
    ...
    series = get_user_series_or_404(db, user_id, series_id)
    delete_series_with_courses(db, series)
...
def get_course_tags(
    ...
    return TagList(items=list_tags(db, user_id))
